...
declare global {
  interface Window {
    waypoint: {
      ...
      voiceCapability():Promise<{stt:{available:boolean;provider:'whisper.cpp';reason:string;binaryPath?:string;modelPath?:string};tts:{available:boolean;provider:'macos-say'|'unavailable';reason:string};rawAudioPersistence:false;cloudSpeech:false}>;
