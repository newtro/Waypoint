...
export class WorkspaceStore {
  ...
  addScreenCaptureToChat(workspaceId:string,id:string,chatId:string):string { this.assertObjectInWorkspace(workspaceId,chatId,'chat'); return this.copyScreenCaptureAttachment(workspaceId,id,chatId,'chat') }
