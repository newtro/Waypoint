...
const allowedTables = new Set(['screen_capture_settings','screen_captures','screen_capture_derivatives','cross_workspace_rollup_settings','cross_workspace_rollup_grants','documents','revisions','chats','messages','memories','memory_suggestions','commitments','rule_suggestion_sources','rule_suggestions','learned_rules','rule_outcomes','relationships','reflection_runs','reflection_sources','reflection_proposals','reflection_proposal_sources','attachments','document_import_sources','meetings','fixture_playbooks','fixture_playbook_runs','local_trigger_settings','local_events','local_trigger_rules','local_trigger_runs','external_inbound_events','automation_proposals','automation_questions','automation_approval_receipts','automation_provisioning_events','automation_rules','automation_runs','tool_gateway_settings','tool_gateway_receipts','tool_failure_knowledge','provider_usage_receipts','hosted_runs','hosted_run_events','activity_capture_settings','activity_snapshots','device_control_settings','remote_jobs','remote_job_events','activities','tombstones','security_profiles','executions','execution_events','provider_sessions','provider_requests'])
