...
contextBridge.exposeInMainWorld('waypoint', {
  ...
  runChat: (workspaceId:string,chatId:string,cli:'codex'|'claude',securityProfileId:string,prompt:string,model?:string,parentExecutionId?:string)=>ipcRenderer.invoke('waypoint:run-chat',{workspaceId,chatId,cli,securityProfileId,prompt,model,parentExecutionId}),
